  ...
  <div class="container-fluid">
    ...
    <main class="col-md-9 min-vh-100 ms-sm-auto col-lg-10 px-md-4" style="background: #016b97;">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-2 border-bottom">
        <h1 class="h1 text-white">Barang keluar</h1>
      </div>
      <div class="row px-3 pt-3 pb-4" style="background: white; border-radius: 1em">
        <div class="col-md-12">
          <div class="row g-5">
            ...
            <div class="col-md-6">
              <h3 class="h3 mb-5 text-center text-blue">Form Barang Keluar</h3>
              <form class="form-group">
                <label for="firstName" class="form-label mt-2">ID Keluar</label>
    ...
    <script type="text/javascript">
      function action(){
        document.getElementByClass("d-flex").style.display="inline-block";
      }
    </script>
  </body>
</html>
