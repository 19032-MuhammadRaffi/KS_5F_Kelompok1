	    ...
	    <!-- content -->
    		<main class="col-md-9 min-vh-100 ms-sm-auto col-lg-10 px-md-4" style="background: #016b97;">
		      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-2 border-bottom">
		        <h1 class="h1 text-white">Data User</h1>
		      </div>
		      <div class="row px-3 pt-3 pb-4" style="background: white; border-radius: 1em">
		      	<h3 class="h3 mb-5 text-center text-blue">Tabel Data User</h3>
		            ...
		            <div class="modal-content">
		              ...
		              <div class="modal-body">
				          <form class="form-group">
				            <h3 class="h3 mb-5 text-center text-blue">Form Buat User</h3>
				            <div class="row d-flex flex-sm-wrap">
				              <div class="col-md-6">
				                <label for="firstName" class="form-label">ID User</label>
				                <input type="text" name="" class="form-control" maxlength="20">
				              </div>
				              <div class="col-md-6">
				                <label for="firstName" class="form-label">Nomor Handphone</label>
				                <input type="text" name="" class="form-control" maxlength="13">
				              </div>                         
				              <div class="col-md-6">
				                <label for="firstName" class="form-label mt-2">Password</label>
				                <input type="text" name="" class="form-control" maxlength="32">
				              </div>
				              <div class="col-md-6">
				                <label for="firstName" class="form-label mt-2">Hak Akses</label>
				              ...
				              <div class="col-md-6">
				                <label for="firstName" class="form-label mt-2">Nama User</label>
