...
//Read Rekap Transaksi
    $sqlRead = "SELECT m.tgl_transaksi, m.keterangan, m.nama_user, d.nama_laptop, d.series, m.jumlah 
...
//Pencarian Data
    if(isset($_POST["searchData"])){
        ...
        $sqlCari = "SELECT m.tgl_transaksi, m.keterangan, m.nama_user, d.nama_laptop, d.series, m.jumlah 
